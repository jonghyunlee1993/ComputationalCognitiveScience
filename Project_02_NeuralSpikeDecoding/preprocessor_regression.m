...
response = [ones(length(spike_density),1,8) spike_density];
xvel = xposition./binsize;
yvel = yposition./binsize;

velocity = [xvel yvel]; 

save -6 data/regression/response.mat response
save -6 data/regression/velocity.mat velocity
